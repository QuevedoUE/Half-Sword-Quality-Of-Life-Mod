...
public:
	...
	class UBorder*                                ButtonsMinusBorder;                                // 0x0368(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UBorder*                                InfoMinusBorder;                                   // 0x04D8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UCanvasPanel*                           MoveCameraKeysMinusCanvasPanel;                    // 0x0518(0x0008)(ExportObject, ZeroConstructor, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	FMulticastInlineDelegateProperty_             ED_FreeCameraFOV;                                  // 0x05F0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             ED_FreeCameraRotation;                             // 0x0600(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void ED_FreeCameraRotation__DelegateSignature(const struct FRotator& RotationValue);
...
static_assert(offsetof(UUI_PhotoMode_C, ButtonsMinusBorder) == 0x000368, "Member 'UUI_PhotoMode_C::ButtonsMinusBorder' has a wrong offset!");
...
static_assert(offsetof(UUI_PhotoMode_C, InfoMinusBorder) == 0x0004D8, "Member 'UUI_PhotoMode_C::InfoMinusBorder' has a wrong offset!");
...
static_assert(offsetof(UUI_PhotoMode_C, MoveCameraKeysMinusCanvasPanel) == 0x000518, "Member 'UUI_PhotoMode_C::MoveCameraKeysMinusCanvasPanel' has a wrong offset!");
