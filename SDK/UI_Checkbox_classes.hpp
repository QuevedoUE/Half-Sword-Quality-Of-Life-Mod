...
public:
	...
	FMulticastInlineDelegateProperty_             OnCheckboxValueChanged;                            // 0x0378(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(offsetof(UUI_Checkbox_C, HorizontalBoxMinusElementsContainer) == 0x000300, "Member 'UUI_Checkbox_C::HorizontalBoxMinusElementsContainer' has a wrong offset!");
