...
public:
	...
	FMulticastInlineDelegateProperty_             SendPhoto;                                         // 0x03A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
