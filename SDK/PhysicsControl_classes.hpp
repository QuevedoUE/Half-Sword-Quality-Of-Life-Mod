...
{
public:
	static void AddControlParameters(struct FPhysicsControlControlAndModifierParameters& InParameters, struct FPhysicsControlControlAndModifierParameters* OutParameters, const class FName Param_Name, const struct FPhysicsControlSparseData& ControlData);
	static void AddModifierParameters(struct FPhysicsControlControlAndModifierParameters& InParameters, struct FPhysicsControlControlAndModifierParameters* OutParameters, const class FName Param_Name, const struct FPhysicsControlModifierSparseData& ModifierData);
...
public:
	...
	bool CreateNamedBodyModifier(const class FName Param_Name, class UMeshComponent* MeshComponent, const class FName BoneName, const class FName Set, const struct FPhysicsControlModifierData& BodyModifierData);
	bool CreateNamedControl(class FName Param_Name, class UMeshComponent* ParentMeshComponent, const class FName ParentBoneName, class UMeshComponent* ChildMeshComponent, const class FName ChildBoneName, const struct FPhysicsControlData& ControlData, const struct FPhysicsControlTarget& ControlTarget, const class FName Set);
	bool DestroyBodyModifier(const class FName Param_Name);
	void DestroyBodyModifiers(const TArray<class FName>& Names);
	void DestroyBodyModifiersInSet(const class FName Set);
	bool DestroyControl(const class FName Param_Name);
	...
	bool ResetBodyModifierToCachedBoneTransform(const class FName Param_Name, const EResetToCachedTargetBehavior Behavior);
	bool ResetControlPoint(const class FName Param_Name);
	bool SetBodyModifierCollisionType(const class FName Param_Name, const ECollisionEnabled CollisionType);
	bool SetBodyModifierData(const class FName Param_Name, const struct FPhysicsControlModifierData& ModifierData);
	...
	bool SetBodyModifierGravityMultiplier(const class FName Param_Name, const float GravityMultiplier);
	bool SetBodyModifierKinematicTarget(const class FName Param_Name, const struct FVector& KinematicTargetPosition, const struct FRotator& KinematicTargetOrienation, const bool bMakeKinematic);
	bool SetBodyModifierMovementType(const class FName Param_Name, const EPhysicsMovementType MovementType);
	bool SetBodyModifierPhysicsBlendWeight(const class FName Param_Name, const float PhysicsBlendWeight);
	...
	bool SetBodyModifierSparseData(const class FName Param_Name, const struct FPhysicsControlModifierSparseData& ModifierData);
	...
	bool SetBodyModifierUpdateKinematicFromSimulation(const class FName Param_Name, const bool bUpdateKinematicFromSimulation);
	bool SetBodyModifierUseSkeletalAnimation(const class FName Param_Name, const bool bUseSkeletalAnimation);
	...
	bool SetControlAngularData(const class FName Param_Name, const float Strength, const float DampingRatio, const float ExtraDamping, const float MaxTorque, const bool bEnableControl);
	bool SetControlData(const class FName Param_Name, const struct FPhysicsControlData& ControlData);
	...
	bool SetControlDisableCollision(const class FName Param_Name, const bool bDisableCollision);
	bool SetControlEnabled(const class FName Param_Name, const bool bEnable);
	bool SetControlLinearData(const class FName Param_Name, const float Strength, const float DampingRatio, const float ExtraDamping, const float MaxForce, const bool bEnableControl);
	bool SetControlMultiplier(const class FName Param_Name, const struct FPhysicsControlMultiplier& ControlMultiplier, const bool bEnableControl);
	...
	bool SetControlParent(const class FName Param_Name, class UMeshComponent* ParentMeshComponent, const class FName ParentBoneName);
	...
	bool SetControlPoint(const class FName Param_Name, const struct FVector& Position);
	...
	bool SetControlSparseData(const class FName Param_Name, const struct FPhysicsControlSparseData& ControlData);
	...
	bool SetControlSparseMultiplier(const class FName Param_Name, const struct FPhysicsControlSparseMultiplier& ControlMultiplier, const bool bEnableControl);
	...
	bool SetControlTarget(const class FName Param_Name, const struct FPhysicsControlTarget& ControlTarget, const bool bEnableControl);
	bool SetControlTargetOrientation(const class FName Param_Name, const struct FRotator& Orientation, const float AngularVelocityDeltaTime, const bool bEnableControl, const bool bApplyControlPointToTarget);
	...
	bool SetControlTargetPoses(const class FName Param_Name, const struct FVector& ParentPosition, const struct FRotator& ParentOrientation, const struct FVector& ChildPosition, const struct FRotator& ChildOrientation, const float VelocityDeltaTime, const bool bEnableControl);
	bool SetControlTargetPosition(const class FName Param_Name, const struct FVector& Position, const float VelocityDeltaTime, const bool bEnableControl, const bool bApplyControlPointToTarget);
	bool SetControlTargetPositionAndOrientation(const class FName Param_Name, const struct FVector& Position, const struct FRotator& Orientation, const float VelocityDeltaTime, const bool bEnableControl, const bool bApplyControlPointToTarget);
	...
	bool SetControlUseSkeletalAnimation(const class FName Param_Name, const bool bUseSkeletalAnimation, const float SkeletalAnimationVelocityMultiplier);
	...
	bool GetBodyModifierExists(const class FName Param_Name) const;
	const TArray<class FName> GetBodyModifierNamesInSet(const class FName Set) const;
	bool GetControlData(const class FName Param_Name, struct FPhysicsControlData* ControlData) const;
	bool GetControlEnabled(const class FName Param_Name) const;
	bool GetControlExists(const class FName Param_Name) const;
	bool GetControlMultiplier(const class FName Param_Name, struct FPhysicsControlMultiplier* ControlMultiplier) const;
	const TArray<class FName> GetControlNamesInSet(const class FName Set) const;
	bool GetControlTarget(const class FName Param_Name, struct FPhysicsControlTarget* ControlTarget) const;
