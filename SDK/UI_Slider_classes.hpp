...
public:
	...
	class UHorizontalBox*                         HorizontalBoxMinusElementsContainer;               // 0x02F8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	FMulticastInlineDelegateProperty_             OnSliderValueChanged;                              // 0x03E8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void GetFocusedOrUnfocusedColor(bool Param_bChangeSliderColorWhenFocused, bool Param_bChangeTextColorWhenFocused, class USlider* Param_Slider, class UImage* ImgLeftButton, class UImage* ImgRightButton, class UWidget* Param_SliderTitle, class UWidget* Param_SliderValue, bool bSetMargin, struct FSlateBrush* LeftButtonColor, struct FSlateBrush* RightButtonColor);
	struct FSlateBrush GetLeftButtonSettings();
	struct FSlateBrush GetRightButtonSettings();
	class FText GetTxtValue();
	void Initialize(double Param_DefaultValue);
	ESlateVisibility LockVisibility();
	struct FEventReply OnMouseButtonDoubleClick(const struct FGeometry& InMyGeometry, const struct FPointerEvent& InMouseEvent);
	void OnMouseEnter(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent);
	void OnMouseLeave(const struct FPointerEvent& MouseEvent);
	struct FEventReply OnMouseWheel(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent);
	void OnSliderValueChanged__DelegateSignature(double Param_SliderValue, bool bReset);
	void PreConstruct(bool IsDesignTime);
	void ResetSlider(bool Param_bShouldFocus);
...
static_assert(offsetof(UUI_Slider_C, HorizontalBoxMinusElementsContainer) == 0x0002F8, "Member 'UUI_Slider_C::HorizontalBoxMinusElementsContainer' has a wrong offset!");
