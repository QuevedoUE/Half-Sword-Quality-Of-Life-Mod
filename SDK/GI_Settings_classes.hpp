...
public:
	...
	FMulticastInlineDelegateProperty_             Set_Player_Dummy;                                  // 0x0208(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             Set_Teammate_Du__y;                                // 0x0218(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             Set_Foe_Dummy;                                     // 0x0228(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void Save_Settings();
	void Set_Foe_Dummy__DelegateSignature();
	void Set_Foe_Equipment();
	void Set_Player_Dummy__DelegateSignature();
	void Set_Player_Equipment();
	void Set_Team_Equipment();
	void Set_Teammate_Du__y__DelegateSignature();
